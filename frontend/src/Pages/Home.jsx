...
const Home = () => {
 ...
 {/*Carousel for popular items*/}
    ...
    <MyCarousel images={PopularItem1} description = "Aqua" />

    <MyCarousel images={PopularItem2} description = "All Natural, Green Goddess"/>

    <MyCarousel images={PopularItem3} description = "Pink Berry Mimosa "/>

    <MyCarousel images={PopularItem4} description = "Salt Air & Honeydew"/>

    <MyCarousel images={PopularItem5} description = "Tangerine, Rose & Blackcurrant"/>

    <MyCarousel images={PopularItem6} description = "What A Man (w/activated charcoal) "/>
    </div>
    </div>
  </div>
  );
